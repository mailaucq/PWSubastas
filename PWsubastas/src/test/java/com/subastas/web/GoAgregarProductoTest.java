...
public class GoAgregarProductoTest extends TestCase{
  ...
  @Test
  public void testGoAgregarProducto() throws Exception {
    ...
    driver.findElement(By.linkText("Agregar Producto")).click();
  }
