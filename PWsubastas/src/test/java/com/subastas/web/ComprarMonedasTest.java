...
public class ComprarMonedasTest  extends TestCase{
  ...
  @Test
  public void testComprarMonedas() throws Exception {
    ...
    driver.get(baseUrl + "/PWsubastas/secured/usuario.htm");
    driver.findElement(By.id("comprarmoneda")).click();
    driver.findElement(By.xpath("//form[@id='moneda']/div/div/div/div/div")).click();
    driver.findElement(By.name("submit")).click();
  }
