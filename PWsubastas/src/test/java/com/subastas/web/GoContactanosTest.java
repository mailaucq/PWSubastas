...
public class GoContactanosTest extends TestCase{
  ...
  @Test
  public void testGoContactanos() throws Exception {
    ...
    driver.get(baseUrl + "/PWsubastas/secured/homeusuario.htm");
    driver.findElement(By.linkText("Contactanos")).click();
  }
