...
public class UploadImageTest extends TestCase{
  ...
  public void testUploadImage() throws Exception {
    ...
    driver.findElement(By.name("datafile")).sendKeys("/home/elizabeth/Imágenes/crowdfundingVista.png");
    driver.findElement(By.name("datafile")).clear();
    driver.findElement(By.name("datafile")).sendKeys("/home/elizabeth/Imágenes/fanbots.jpg");
    driver.findElement(By.name("datafile")).clear();
    driver.findElement(By.name("datafile")).sendKeys("/home/elizabeth/Imágenes/ginji.jpg");
  }
